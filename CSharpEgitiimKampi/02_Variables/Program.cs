...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //string passengerName,passengerSurnname,passengerDistrict,passengerCity,passengerAge,
            ...
            //Console.Write("Yolcu Kimlik: ");
            //passengerIdentityNumber = Console.ReadLine();

            //Console.WriteLine();
            //Console.WriteLine("Yolcu TC Kimlik No: " + passengerIdentityNumber + " - Yolcu Ad Soyad: " + passengerName+ " " + passengerSurnname + " " + passengerDistrict + " / "+
            ...
            //Console.WriteLine("Bu ürünlerin toplam fiyatı "+ totalPrice);
